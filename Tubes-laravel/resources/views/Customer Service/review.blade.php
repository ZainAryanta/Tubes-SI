...
<div class="container-fluid">
    <h1 class="h3 mt-2 mb-2 text-gray-800">Data Review</h1>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action='/Review' method='POST'>
                                        ...
                                        <div class="form-group">
                                            <label for="jenisBarang1">Email</label>
                                            <select class="form-control" name="email">
                                                <option class="">- Silahkan Pilih -</option>
                                                @foreach ($kon as $items)
                                                <option value="{{ $items->email}}">{{ $items->email }}
                                                </option>
                                                @endforeach
                                                @foreach ($pel as $items)
                                                <option value="{{ $items->email}}">{{ $items->email }}
                                        ...
                                        <div class="form-group">
                                            <label for="hargaBarang1">Isi Review</label>
                                            <input type="text" class="form-control" id="hargaBarang1" name='isi' />
                                        </div>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="/Review/{{ $kon->id }}" method="post">
                                                            @method('DELETE')
                                                            @csrf

...
<div class="container-fluid">
    <h1 class="h3 mt-2 mb-2 text-gray-800">Data Pelanggan</h1>

    <div class="card shadow mb-4">
        <div class="card-header py-3">

            <div class="d-flex align-items-center">
                <a class="d-none py-2 m-2 d-sm-inline-block btn btn-sm btn-primary shadow-sm" href="/pdf-pelanggan"><i
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action='/Pelanggan' method='POST'>
                                        ...
                                        <div class="form-group">
                                            <label for="hargaBarang1">Email Pelanggan</label>
                                            <input type="text" class="form-control" id="hargaBarang1" name='email' />
                                        </div>

                                        <div class="form-group">
                                            <label for="hargaBarang1">No.WA</label>
                                            <input type="text" class="form-control" id="hargaBarang1" name='telp' />
                                        </div>

                                        <div class="form-group">
                                            <label for="jumlahBarang1">Jumlah Transaksi</label>
                                        ...
                                        <div class="modal fade" id="barang{{$kon->id}}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/Pelanggan/{{ $kon->id }}" method="POST">
                                                            @method('PUT')
                                                            @csrf
